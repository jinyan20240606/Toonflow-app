// @routes-hash b9b07b5189711fe841a574914f8e5924
...
import route69 from "./routes/production/storyboard/cancelStoryboardGenerate";
...
import route73 from "./routes/production/storyboard/mergeStoryboard";
...
import route91 from "./routes/production/workbench/openInJianying";
...
import route151 from "./routes/setting/rateLimit/getRateLimit";
import route152 from "./routes/setting/rateLimit/updateRateLimit";
...
export default async (app: Express) => {
  ...
  app.use("/api/production/storyboard/cancelStoryboardGenerate", route69);
  ...
  app.use("/api/production/storyboard/mergeStoryboard", route73);
  ...
  app.use("/api/production/workbench/openInJianying", route91);
  ...
  app.use("/api/setting/rateLimit/getRateLimit", route151);
  app.use("/api/setting/rateLimit/updateRateLimit", route152);
