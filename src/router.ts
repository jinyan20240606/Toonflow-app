// @routes-hash e9c88b36bc3030886c3b1c0d23ceaebe
...
import route89 from "./routes/production/workbench/openInJianying";
...
import route149 from "./routes/setting/rateLimit/getRateLimit";
import route150 from "./routes/setting/rateLimit/updateRateLimit";
...
export default async (app: Express) => {
  ...
  app.use("/api/production/workbench/openInJianying", route89);
  ...
  app.use("/api/setting/rateLimit/getRateLimit", route149);
  app.use("/api/setting/rateLimit/updateRateLimit", route150);
